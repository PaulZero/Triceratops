...
namespace Triceratops.DockerService.Managers.ClientManager
{
    public class DockerClientManager
    {
        ...
        public async Task<Stream> GetContainerLogStreamAsync(string containerId, bool tail = true)
        {
            try
            {
                using var dockerClient = CreateDockerClient();
